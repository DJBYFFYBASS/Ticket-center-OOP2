...
public class OrgEventWF {
    ...
    private static ShowRepository showRepository=ShowRepository.getInstance();
    ...
    public static void Update(String Title, String Date, String Location, String Max, String Tickets,String Status,String Type,Organizer Org,String Distributor, String ID)
    { Show show=new Show();
        List<Show> shows= showRepository.infoById(ID);
        try{
            show=shows.get(0);
        }catch (Exception e)
        {
